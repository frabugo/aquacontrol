        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" step="0.000001" min="0" required className={inputCls} value={form.meta_soles}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" step="0.000001" min="0" max="100" className={inputCls} value={form.comision_pct}
            ...
            <div>
              ...
              <input type="number" step="0.000001" min="0" className={inputCls} value={form.bono_cumplido}
